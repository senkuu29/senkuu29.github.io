...
<template>
  <div
    ...
    <article data-page="about">
      ...
      <section
        class="text-sm md:text-lg text-justify flex flex-col gap-4 md:flex-row md:gap-4 md:justify-left md:items-center">
        <div class="flex justify-center">
          <img class="w-1/2 md:h-auto rounded-full border-4 pict"
            src="../../public/img/fotosaya.jpg" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everybody! My name is Deden Ahmad Jamil. I am a web creation student from SMKN 2 Subang, West Java. 
            I really enjoy what I am doing at the moment, I think making programs is not just a job, but also art that has aesthetic value
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; I don't describe much,
            I'm here just aspiring to be a person who is useful to others and myself, I will continue to try as hard as I can to be the best
          </p>
        </div>
