    ...
    return {
      ...
      items: [
        ...
        // },
        {
          ...
          name: 'React Crud',
          imageUrl: 'react-crud',
          status: 'react crud is a twelfth grade UJIKOM preparation project for vocational high schools. ',
          tech: 'Tugas belajar kelas XII RPL',
          github: 'https://github.com/senkuu29/crud_dengan_react',
          demo: 'null'
        },
        {
          id: 3,
          name: 'Lomba O2sn',
          imageUrl: 'lomba-o2sn',
          status: 'Here I won a martial arts competition between vocational students in Subang district and continued to the province to represent the district',
          tech: 'Moment that is very hard to forget',
          github: 'null',
          demo: 'https://www.instagram.com/p/C6ti4WRRnZk/?img_index=2'
        },
        // {
        //   id: 4,
        //   name: 'Bumdesma',
      ...
      <header>
        <div
          ...
          <h4 class="text-base font-normal text-transparent bg-clip-text bg-gradient-to-r from-slate-100 to-amber-300">
            Explore the I've worked on so far</h4>
        </div>
      </header>
      <section>
        <div>
